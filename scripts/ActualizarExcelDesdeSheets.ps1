...
# La cabecera del Sheet ("AUTOR / TITULO / N Inventario") esta en la fila 4
$csv = $contenido | ConvertFrom-Csv -Header Fecha, NroInventario, Autor, Titulo | Select-Object -Skip 4
