...
export const changeObservaciones = async (observaciones: string, nombreSocio: string): Promise<boolean> => {
    ...
    worksheet.eachRow((row, rowIndex) => {
        ...
        if (socio.nombreYApellido === nombreSocio) {
            writeSocio(row, { ...socio, observaciones: observaciones })
            found = true
        }
    })
